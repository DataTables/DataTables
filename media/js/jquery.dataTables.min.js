...
c,d){var e=b.aoData,h=e[c],g,f,l,p,n;e.splice(c,1);g=0;for(f=e.length;g<f;g++)if(l=e[g],n=l.anCells,null!==l.nTr&&(l.nTr._DT_RowIndex=g),null!==n)for(l=0,p=n.length;l<p;l++)n[l]._DT_CellIndex.row=g;qa(b.aiDisplayMaster,c);qa(b.aiDisplay,c);qa(a[d],c,!1);Ta(b);c=b.rowIdFn(h._aData);c!==m&&delete b.aIds[c]});this.iterator("table",function(a){for(var b=0,d=a.aoData.length;b<d;b++)a.aoData[b].idx=b});return this});t("rows.add()",function(a){var b=this.iterator("table",function(b){var c,d,g,f=[];d=0;for(g=
...
"next"]},full:function(a,b){return["first","previous","next","last"]},numbers:function(a,b){return[ja(a,b)]},simple_numbers:function(a,b){return["previous",ja(a,b),"next"]},full_numbers:function(a,b){return["first","previous",ja(a,b),"next","last"]},first_last_numbers:function(a,b){return["first",ja(a,b),"last"]},_numbers:ja,numbers_length:7});f.extend(!0,q.ext.renderer,{pageButton:{_:function(a,b,c,d,e,h){var g=a.oClasses,k=a.oLanguage.oPaginate,l=a.oLanguage.oAria.paginate||{},p,n,q=0,t=function(b,
d){var m,r,v,u,w=function(b){Ua(a,b.data.action,!0)};m=0;for(r=d.length;m<r;m++)if(u=d[m],f.isArray(u))v=f("<"+(u.DT_el||"div")+"/>").appendTo(b),t(v,u);else{p=null;n="";switch(u){case "ellipsis":b.append('<span class="ellipsis">&#x2026;</span>');break;case "first":p=k.sFirst;n=u+(0<e?"":" "+g.sPageButtonDisabled);break;case "previous":p=k.sPrevious;n=u+(0<e?"":" "+g.sPageButtonDisabled);break;case "next":p=k.sNext;n=u+(e<h-1?"":" "+g.sPageButtonDisabled);break;case "last":p=k.sLast;n=u+(e<h-1?"":
