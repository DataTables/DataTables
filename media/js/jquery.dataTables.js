...
(/** @lends <global> */function( $ ) {
	...
	function _fnBuildAjax( oSettings, data, fn )
	{
		...
		var baseAjax = {
			...
			"success": function (json) {
				...
				//Should call the error callback, not
				//log everything with an alert.
				var _errorCabllack = this.error; //since we don't have it globally.
				_errorCabllack(this.xhr, json.error, null);
	...
	function _fnLog( settings, level, msg, tn )
	{
		...
		/** Currently all _fnLog calls have level=0
		  * so this will ALWAYS alert.
		  **/
		if ( ! level  ) {
